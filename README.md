...
- **Data Access Layer**:
    ...
    - **Queries** ([`internal/queries`](internal/queries)): Hand-typed SQL queries that get fed to sqlc for type-safe go functions that get evaluated at compile-time to be generated from.
...
*Just make sure you set the env variables that you care for!*
